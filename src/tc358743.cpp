...
// Declares HDMI sink, physical address 1.0.0.0, max TMDS 165 MHz
const uint8_t EDID_1080P30[256] = {
    0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00,
    0x4C, 0x2D, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00,
    0xFF, 0xFF, 0x01, 0x04, 0x88, 0x20, 0x12, 0x78,
    0x84, 0xEE, 0xA3, 0x54, 0x4C, 0x99, 0x91, 0x26,
    ...
    0x42, 0x50, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03,
    0x00, 0x00, 0x00, 0xFC, 0x00, 0x48, 0x44, 0x4D,
    0x49, 0x2D, 0x44, 0x49, 0x53, 0x50, 0x4C, 0x41,
    0x59, 0x0A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0xCD,
    0x02, 0x03, 0x00, 0x00, 0x1F, 0x00, 0x0C, 0x03,
    0x10, 0x00, 0x00, 0x21, 0x11, 0xA2, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
bool TC358743::begin(int sda_pin, int scl_pin, int reset_pin) {
    ...
    const uint32_t REFCLK_HZ = 26000000;
    ...
    // ------ Write EDID and assert HPD (matching Linux driver sequence) ------
    ...
    bool edidOk = writeEdidByteByByte(EDID_1080P30, sizeof(EDID_1080P30));
    ...
    writeReg8(EDID_LEN1, sizeof(EDID_1080P30) & 0xFF);
    writeReg8(EDID_LEN2, (sizeof(EDID_1080P30) >> 8) & 0xFF);
